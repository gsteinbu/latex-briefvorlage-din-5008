...
% Online marke als background der ersten Seite
...
\IfFileExists{online-marke.pdf}{
	% File exists
	% <! START SOURCE https://latex.org/forum/viewtopic.php?t=26829
